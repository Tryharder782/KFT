...
const CreatePostBlock = ({newPostText, setNewPostText, postCreateTabHide, setPostCreateTabHide, postCreate}) => {

	
	return (
		<div className='CreatePostBlock'>
			<div className="buttonBlock" onClick={() => setPostCreateTabHide(false)}>
